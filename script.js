...
window.onload = function() {
	...
	class avatar {
		...
		compliment2(){
			return `I look good in this ${this.bottoms}!`
		}
		compliment3(){
		...
		mission(){
			...
			A ${this.bottoms}, and my cool ${this.accessory}. Hair color ${this.hair}!`
		}
		congrats(){
			return 	`Woo-hoo! You did it! Now That I look Fabolous, We can head Downstairs and Meet Our Date!.`
		}

	};


	let niecey = new avatar("Niecey","Red","Demin Skirt","Hat","Blonde");
	let niecey2 = new avatar("Niecey","White","Cool Grey","Necklace","Red");
	let niecey3 = new avatar("Niecey","Black","Dark Demin","Shades","Black");
	...
	let checkObj = {top: '', bottom:'', accessory:'', hair: ''}

	const outfits = [
	{top: 'Images/crop1.png',bottom:"Images/bottom1.png",accessory:"Images/hat.png",hair:"Images/hairstyle1.png"},
	{top: 'Images/crop2.png',bottom:"Images/bottom2.png",accessory:"Images/glasses.png",hair:"Images/short-brunnette.png"},
	{top:'Images/crop3.png',bottom:"Images/bottom3.png",accessory:"Images/necklace.png",hair:"Images/black-long.png"}
	];
	...
	const create_hair_style =()=>{
				...
				if (evnt.target === hair1) {
					...
					headTarget.style.backgroundRepeat = "no-repeat";
					headTarget.style.marginLeft = "26 px";
					headTarget.style.backgroundSize = "cover";
					...
					headTarget.style.backgroundRepeat = "no-repeat";
					headTarget.style.backgroundSize = "cover"
					headTarget.style.marginLeft = "18px";
		...
		for (let y = 0; y < 3; y++) {
			...
			topDivs[y].addEventListener('click',(evnt)=>{
				...
				if (evnt.target === top1) {
					...
					topTarget.style.backgroundRepeat = "no-repeat";
					topTarget.style.backgroundSize = "cover";
					topTarget.style.marginTop= "10px";
 	...
 	const create_bottom = ()=>{
 		for (let z = 0; z < 3; z++) {
			...
			evnt.target.style.transform = "scale(1.1)"
					...
					bottomTarget.style.backgroundRepeat = "no-repeat";
					bottomTarget.style.marginTop= "3px"
					bottomTarget.style.marginLeft= "3px"
					bottomTarget.style.backgroundSize = "cover"
